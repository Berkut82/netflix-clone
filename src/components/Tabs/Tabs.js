              ...
              <div className='tab-2-content-bottom'>
                <div>
                  ...
                  <p className='text-dark'>
                    SmartTVs, PlayStation, Xbox, Chromecast, Apple TV, Blu-ray
                    players and more
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className='text-dark'>Watch rigth on Netflix.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='container'>
            ...
            >
              ...
              <table className='table'>
                ...
                <tbody>
                  <tr>
                    <td>Monthly price after free month ends on 01/02/2022</td>
                    <td>$6.99</td>
                    <td>$11.99</td>
                    <td>$15.99</td>
                  </tr>
